  ...
  fields: {
    ...
    updateAuthor: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "author" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
          })
          .catch(err => {
    ...
    addBook_order: {
      ...
      resolve(parent, args) {
        const sql =
          'INSERT INTO "book_order" (book_id, order_id) VALUES ($1, $2) RETURNING *';
        return connect.conn
          .one(sql, [args.book_id, args.order_id])
          .then(data => {
            return data;
          })
          .catch(err => {
    ...
    updateBook_order: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "book_order" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
    ...
    addBooks: {
      ...
      resolve(parent, args) {
        const sql =
          'INSERT INTO "books" (genre_id, test, name, publish_date, author_id) VALUES ($1, $2, $3, $4, $5) RETURNING *';
        return connect.conn
          .one(sql, [
            args.genre_id,
            args.test,
    ...
    updateBooks: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "books" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
    ...
    updateGenre: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "genre" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
    ...
    addOrder: {
      ...
      resolve(parent, args) {
        const sql =
          'INSERT INTO "order" (created_at, user_id, status_id, shipping_id) VALUES ($1, $2, $3, $4) RETURNING *';
        return connect.conn
          .one(sql, [
            args.created_at,
            args.user_id,
    ...
    updateOrder: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "order" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
    ...
    addShipping_method: {
      ...
      resolve(parent, args) {
        const sql =
          'INSERT INTO "shipping_method" (method) VALUES ($1) RETURNING *';
        return connect.conn
          .one(sql, [args.method])
          .then(data => {
            return data;
    ...
    updateShipping_method: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "shipping_method" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
    ...
    updateStatus: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "status" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
    ...
    addUser: {
      ...
      resolve(parent, args) {
        const sql =
          'INSERT INTO "user" (phone_number, address, name) VALUES ($1, $2, $3) RETURNING *';
        return connect.conn
          .one(sql, [args.phone_number, args.address, args.name])
          .then(data => {
            return data;
          })
          .catch(err => {
    ...
    updateUser: {
      ...
      resolve(parent, args) {
        ...
        const sql =
          'UPDATE "user" SET ${updateValues} WHERE "id" = $1 RETURNING *';
        return connect.conn
          .one(sql, [args.id, ...Object.values(args)])
          .then(data => {
            return data;
